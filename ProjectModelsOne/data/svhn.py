...
from .vtab_helpers import _collate
...
class SVHNDataModule(BaseDataModule):
    ...
    def setup(self):
        ...
        full_train = SVHN(self.data_root, split="train", download=self.download, transform=self.t_train)
        full_eval = SVHN(self.data_root, split="train", download=self.download, transform=self.t_eval)
        test = SVHN(self.data_root, split="test", download=self.download, transform=self.t_eval)
