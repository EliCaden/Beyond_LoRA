...
# ----- main -----
def main():
    ap = CommentArgParser(description='RAW PCA/SVD directions for paper-style analysis + projected path.', fromfile_prefix_chars='@')
    ...
    print(f"[PCA] Wrote directions: {out_dir}/dirX.pth & dirY.pth (RAW, paper-style analysis).")
