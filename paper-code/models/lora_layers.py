...
class LoRALinearAdapter(nn.Module):
    ...
    Notes:
      ...
      - detach_base=True (default) prevents gradients into base even if someone unfreezes it later.
        Set detach_base=False if you intentionally want to fine-tune base weights while wrapped.
    ...
    def notify_optimizer_step(self) -> None:
        """
        Call AFTER each optimizer.step() if you want mask refresh cadence based on optimizer steps.
        """
